...
| 3    | link:src/main/java/iut/sae/algo/Sobriete.java[meilleur Java]| Java      | Sobriété     
|==========================================================================
...
- Java 21 ou Java 17, ou autre
- Python 3.11.9 ou autre
- ...
...
- link:https://www.codacy.com/z[Codacy]
- link:https://replit.com/[Replit pour le C]
- ...
